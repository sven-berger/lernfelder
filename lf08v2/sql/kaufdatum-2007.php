...
SELECT * FROM lf08v2_fahrraeder WHERE YEAR(kaufdatum) = 2007 ORDER BY `lf08v2_fahrraeder`.`kaufdatum` ASC;

<?php include("middle.php"); ?>

<?php
    $sql = "SELECT * FROM lf08v2_fahrraeder WHERE YEAR(kaufdatum) = 2007 ORDER BY `lf08v2_fahrraeder`.`kaufdatum` ASC;";
